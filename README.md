...
2. 下載[設定檔](https://github.com/jamessa/qmk_firmware/raw/jsa/keyboards/pragmatic/keymaps/vial/vial.json)。*Windows用戶按<kbd>Control</kbd>+滑鼠主鍵即可以下載；Mac用戶按<kbd>Command</kbd>+滑鼠主鍵即可以下載。*
