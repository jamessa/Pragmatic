...
## 42、36配列鍵盤的都是用什麼中文輸入法

- 許氏注音，很好上手。如果習慣用注音，且習慣Windows作業系統，直接轉許式鍵盤吧！看用Win10內建的自定義鍵盤，還是古早的Yahoo 奇摩輸入法（有特殊設定方式開啟許氏鍵盤），都不錯用
- 嘸蝦米只用英文字母，含選字，不太需要選。
- 大新倉頡
- 雙碼注音
- [漢語拼音](http://jamessa.github.io/hanyu/漢語拼音/zhuyin/注音/2013/12/30/learn-chinese-pinyin.html)
